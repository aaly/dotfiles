...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ " *Main", " @IM", " &Internet", " $Programming", " #Media", " >Monitor" }, s, layouts[1])
end
-- }}}
...
cpuwidget:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0, 
"#FF5656"}, {0.5, "#88A175"}, 
                    {1, "#AECF96" }}})
-- Register widget
...
awful.key({ modkey }, "h", function ()
    ...
    --awful.key({ "Control_L"}, "Right", function() awful.util.spawn("xdotool click 3") end),
    --awful.key({ "Control_L",}, "Left", function() awful.util.spawn("xdotool click 2") end),
--    awful.key({ "Control_L",}, "click 1", function() awful.util.spawn("xdotool click 3") end),
...
--    awful.key({ modkey, }, "r", function (c)  awful.util.spawn("xboomx")  end),
--    awful.key({ modkey, }, "r", function (c)  awful.util.spawn("hypermenu run")  end),
...
awful.key({ modkey, "Shift"   }, "Right",
  function (c)
    ...
    awful.key({ modkey, }, "-", function (c) set_opacity(c, -0.1) end),
    awful.key({ modkey, }, "=", function (c) set_opacity(c, 0.1) end),
...
gears.wallpaper.maximized("/home/dude/.bg.jpg", s, true)
  end
